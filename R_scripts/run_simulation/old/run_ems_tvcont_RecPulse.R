# Purpose: To run EMs that have time-varying continuous selectivity as penalized likelihoods for the recruitment pulse test cases
...
ncores <- detectCores() 
# Set up cluster here
cl <- makeCluster(ncores - 3, type = "SOCK")
registerDoSNOW(cl)
