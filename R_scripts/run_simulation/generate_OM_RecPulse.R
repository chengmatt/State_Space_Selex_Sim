# # Purpose: Generate OMs for Recruitment Pulse Test Case
...
for(n_om in 1:n_OM_scen) {
  ...
  Fl_Chg_Rec_Pulse <- om_scenarios$Fl_Chg_Rec_Pulse[n_om]
  ...
  oms <- simulate_data(fxn_path = fxn_path, 
                       ...
                       m_ratio = 0.5,
                       Fl_Chg_Rec_Pulse = Fl_Chg_Rec_Pulse, # Whether or not to have a recruitment pulse
                       Rec_Pulse_Mult = 10, # Recruitment Pulse Multiplier
                       # Fishery Controls
                       Fish_Start_yr = c(1, 1), 
                       F_type = F_type,
                       Start_F = Start_F, 
