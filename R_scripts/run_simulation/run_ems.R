# Purpose: To run EMs that aren't self-tests (full-factorial design here)
...
for(n_om in 1:n_OM_scen) {
  ...
  for(n_em in 1:n_EM_scen) {
    ...
    if(time_block_boolean == TRUE) { # if there is time-blocking going on
